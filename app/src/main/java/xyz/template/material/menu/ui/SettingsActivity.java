...
public class SettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.setting_quit_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UCSManager.disconnect();//注销
                PrefUtils.markTosLoged(SettingsActivity.this, null, false);
